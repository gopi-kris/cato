...
jobs:
  - id: https://travis-ci.org/gopi-kris/cat_anatomy_ontology
    type: travis-ci
build:
  checkout: git clone https://github.com/gopi-kris/cat_anatomy_ontology.git
  system: git
  path: "."
contact:
  email: 
...
domain: stuff
homepage: https://github.com/gopi-kris/cat_anatomy_ontology
products:
  - id: cato.owl
...
tracker: https://github.com/gopi-kris/cat_anatomy_ontology/issues
license:
